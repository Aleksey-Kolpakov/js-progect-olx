...
export function DynamicMarkUp(obj) {
  ...
  formImgList.insertAdjacentHTML(
    'beforeend', ///--->>
    '<li class="item download__item start-list-item"><label class= "download__label" > <img class="download__img" width="78" height="50" ><input class="download__input visually-hidden" required type="file" multiple /></label></li > ',
  );
